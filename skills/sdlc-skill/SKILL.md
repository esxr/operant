...
**Template:** See [hld-template.md](hld-template.md)
...
**Template:** See [eis-template.md](eis-template.md)
...
- The PostToolUse hook detects the artifact write and advances the FSM
- The pipeline will BLOCK you and say "wait for review"
- An outbound call/message to the user will happen automatically
- Once the user approves, the pipeline will tell you to proceed
- If the user requests changes, you'll receive their feedback
